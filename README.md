...
- Servidor
    ...
    - Notificación de batch recibido correctamente, donde :
        - STATUS = SUCCESS
        - BET_AMOUNT = Cantidad de apuestas recibidas 

    - Notificación de batch con error, donde :
        - STATUS = FAIL
        - BET_AMOUNT = 0
...
A medida que iba desarrollando los ejercicios me fui dando cuenta, principalmente del ejercicio 5 en adelante, que tanto el protocolo de comunicación, como la separación de responsabilidades no era la mejor y por ello fui modificando la estructura del código llevando a una mejor solución. 
